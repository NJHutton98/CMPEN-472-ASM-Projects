***********************************************************************
*
* Title:          Rapid Data Transmission with HCS12
*
...
*
* Program:        Interrupt program that 
*                 
*
...
iYes        DS.B    1                ; interrupt occurred flag
...
swWait		  LDAA	PORTB			    ; Wait for user to flip SW0			
      			...
      			clr   iYes           ; clear the interrupt flag
      			jsr		StartTimer2oc
...
numLoop
      			...
      			ldd		TC2H			; load the number from the counter         
      			pshx
...
msg4          DC.B    '> When ready, press the switch SW0 for 1024 point data transmit.', $00
